...
function ensureSeed() {
  ...
  const DEFAULT_SETTINGS = {
    ...
    social_twitter: "",
    seo_default_title: "Web Development, SEO & AI Workflow Studio",
    seo_default_description: "Okkarhys is a digital consulting studio in Indonesia helping personal brands and businesses grow through web development, SEO, AI-driven workflows, and content strategy built for measurable results.",
